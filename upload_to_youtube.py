"""
YouTube Upload Script for Velocity Ukrainian
"""
...
def ensure_playlist(youtube, title="Learn Ukrainian Phrases for Beginners | Velocity Ukrainian", description="All ukrainian phrases videos in one playlist. 🇺🇦 Learn Ukrainian with Velocity Ukrainian!"):
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Ukrainian with Velocity Ukrainian"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Ukrainian", "Ukrainian Phrases", "Ukrainian Language", "Velocity Ukrainian", "Ukrainian for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY UKRAINIAN - YOUTUBE UPLOADER")
