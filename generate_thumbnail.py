...
SCENIC_STYLES = [
    "stunning Ukrainian woman in traditional embroidered dress, Kyiv, Saint Sophia Cathedral, sunny day",
    "elegant Ukrainian woman in traditional vyshyvanka, Lviv Old Town, Market Square, morning light",
    "beautiful Ukrainian woman in modern attire, Kyiv waterfront, Dnipro river, sunset glow",
    "Ukrainian girl at white sand beach, Odesa coast, Black Sea, crystal clear water, turquoise sea",
    "gorgeous Ukrainian woman in traditional folk dress, Carpathian Mountains, Hoverla peak, golden hour",
    "beautiful Ukrainian woman with sunflowers, Ukrainian countryside, soft morning light",
    "Ukrainian woman in traditional attire, Chernivtsi University, colorful buildings, vibrant atmosphere",
    "elegant Ukrainian woman, Kharkiv, Shevchenko Garden, serene courtyard, peaceful blue hour",
]


def generate_scenic_image(category_english: str, category_ukrainian: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Ukrainian", category_english)
    if premade:
        return premade
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Ukrainian language learning video. "
                f"{style}. "
                ...
                f"At top: '120 UKRAINIAN PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY UKRAINIAN'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 UKRAINIAN PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
